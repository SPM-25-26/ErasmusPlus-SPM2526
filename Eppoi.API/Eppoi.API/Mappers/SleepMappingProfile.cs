...
{
    public class SleepMappingProfile : Profile
    {
        public SleepMappingProfile()
        {
            CreateMap<PoisSleep, SleepSummaryDto>()
            ...
            CreateMap<PoisSleep, SleepDetailDto>()
                .IncludeBase<PoisSleep, SleepSummaryDto>()
