...
{
    public class EntertainmentMappingProfile : Profile
    {
        public EntertainmentMappingProfile()
        {
            CreateMap<PoisEntertainmentLeisure, EntertainmentSummaryDto>()
            ...
            CreateMap<PoisEntertainmentLeisure, EntertainmentDetailDto>()
                .IncludeBase<PoisEntertainmentLeisure, EntertainmentSummaryDto>()
