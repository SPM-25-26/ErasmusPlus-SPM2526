...
// FIX DEFINITIVO PER VITE: usiamo le immagini direttamente dal web
...
function InteractiveMap() {
  ...
  return (
    <div style={{ padding: '40px 20px', width: '100%', maxWidth: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ height: '70vh', width: '100%', borderRadius: '16px', overflow: 'hidden', border: '2px solid #333' }}>
                ...
                <Popup>
                  <div style={{ textAlign: 'center', padding: '5px' }}>
                    ...
                    {detailPath !== '#' ? (
                      ...
                      <span style={{ color: '#888', fontSize: '0.8rem' }}>Dettagli non disponibili</span>
                    )}
                  </div>
                </Popup>
              </Marker>
